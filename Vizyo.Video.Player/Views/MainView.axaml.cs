...
public partial class MainView : UserControl
{
    public MainView()
    {
        ...
        //var player3 = new VlcPlayerView() { Width = 300, Height = 200, Source = "https://test-videos.co.uk/vids/bigbuckbunny/mp4/av1/360/Big_Buck_Bunny_360_10s_1MB.mp4" };
        ...
        //var player2 = new MpvPlayerView() { Width = 300, Height = 200, Source = "http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ElephantsDream.mp4" };
        //Canvas.SetLeft(player2, 400); Canvas.SetTop(player2, 10);
        //MainCanvas.Children.Add(player2);

        //var player3 = new MpvPlayerView() { Width = 300, Height = 200, Source = "https://test-videos.co.uk/vids/bigbuckbunny/mp4/av1/360/Big_Buck_Bunny_360_10s_1MB.mp4" };
        //Canvas.SetLeft(player3, 100); Canvas.SetTop(player3, 300);
        //MainCanvas.Children.Add(player3);
        ...
        var grid = new CustomPlayer1(600, 340).GetPlayer("https://test-videos.co.uk/vids/bigbuckbunny/mp4/av1/360/Big_Buck_Bunny_360_10s_1MB.mp4");
